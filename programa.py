...
if __name__ == "__main__":
    ...
    # Se llama a la función suma_1_al_10() para obtener el resultado
...
def imprimir_datos_personales(nombre, edad, estatura):
    print("Nombre:", nombre)
    print("Edad:", edad)
    print("Estatura:", estatura)# Se imprimen en pantalla los datos personales recibidos como argumentos
...
if __name__ == "__main__":
    ...
    print(area) # Se imprime el área calculada del círculo
